insert into Spitter (username, password, email) values ('habuma', 'password', 'craig@habuma.com');
insert into Spitter (username, password, email) values ('mwalls', 'password', 'mwalls@habuma.com');
insert into Spitter (username, password, email) values ('chuck', 'password', 'chuck@habuma.com');
insert into Spitter (username, password, email) values ('artnames', 'password', 'art@habuma.com');
